...
if ( ! class_exists( 'Social_Media_Expert_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Social_Media_Expert_WPTT_WebFont_Loader {
		 ...
		 * @var string
		 */
		protected $social_media_expert_css;
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Social_Media_Expert_WPTT_WebFont_Loader( $url );
